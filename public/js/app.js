...
function browser(action){
  ...
  var forumNameContainer = document.createElement("div"); forumNameContainer.id = "forumNameContainer"; forumNameContainer.className = "forumName"
  ...
  if(action === "gdForumClick"){
      inBrowser = 1; inSubForum = 1;
      $("#forumContainer").hide(); $("#userIconCircle").hide();
  ...
  $("#backArrow").click(function() {
    if(inSubForum === 1){
    $("#forumContainer").show(); $("#userIconCircle").show();
    $("#backArrow").hide();
    $(".forumName").remove();
    $("#rfBarGrid").children().show(); $("#rfBarGrid").removeClass("rfBarForum");
  ...
  console.log(this)
    if(this.id === "gdButton"){
      ...
      forumContainer.appendChild(scienceSubForums);
        ...
        var foreignSubForum = document.createElement("div");
        foreignSubForum.id = "foreignSubForum";
        forumContainer.appendChild(foreignSubForum);
